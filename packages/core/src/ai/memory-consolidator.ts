...
- "archive" → info toujours utile mais pas quotidiennement (lecons apprises, anciennes situations). Sera disponible via recherche semantique.
      ...
      try {
        ...
        switch (decision.action) {
          ...
          case 'delete':
            ...
            break;
          case 'renew': {
            // Find the original entry to get its content
